...
This file is loaded every session. It tells you how to work with me on this project.

## Who I am

I am **not** a programmer. I'm building this project with your help. Assume I don't
...
- You do all the technical work: setting things up, installing what's needed, saving
  versions (git), running and testing the project. I shouldn't need to touch a terminal.
...
- If something breaks, tell me plainly what went wrong and what you'll try — don't hide it.

## When you review my project
