...
.DESCRIPTION
  ...
  caveman, agent-sdk-dev), the Playwright MCP server, a read-only gh (GitHub CLI)
  allowlist, and my default model. Not tied to any project. -Force overwrites an existing
