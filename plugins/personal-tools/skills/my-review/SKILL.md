---
name: my-review
description: Deep, security-weighted review of your changes or a PR — runs inside the my-review agent (inherit model, max reasoning). Read-only, report-only. Use for "/my-review", "/my-review <PR#>".
